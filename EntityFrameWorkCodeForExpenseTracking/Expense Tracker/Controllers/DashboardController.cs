...
namespace Expense_Tracker.Controllers
{
    public class DashboardController : Controller
    {
        ...
        public async Task<ActionResult> Index()
        {
            ...
            // Set culture for Indian Rupees or customize with a specific symbol for Rupiya
            CultureInfo culture = CultureInfo.CreateSpecificCulture("hi-IN");
            culture.NumberFormat.CurrencySymbol = "रु ";  // You can set to "रु" for Nepalese Rupees or similar
